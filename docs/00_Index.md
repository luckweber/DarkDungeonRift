...
| 64 | [M3 Decals: Sombra & Telegrafe](systems/64_M3_Decals_Telegraph_Setup.md) 🆕 | **Passo a passo editor:** `M_BlobShadow` correto, `M_Telegraph` círculo/cone/linha, `BP_TelegraphDecal` + GameplayCues `Enemy.Telegraph`/`Proj.Telegraph`, decals no player e inimigos, troubleshooting |
